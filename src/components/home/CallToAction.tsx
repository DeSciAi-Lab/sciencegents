...
import { ArrowRight, Beaker, Brain, Dna } from 'lucide-react';
  ...
  return (
    <div className="relative py-20 overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-5xl mx-auto glass-panel p-8 md:p-14">
              ...
              <Reveal delay={200}>
                <div className="flex flex-col sm:flex-row gap-4">
                  <Button 
                    ...
                    className="bg-science-600 hover:bg-science-700 text-white group"
                    size="lg"
                  >
                  ...
                  <Button 
                    ...
                    variant="outline"
                    size="lg"
                    className="border-science-200 hover:border-science-300 hover:bg-science-50"
                  >
                    Explore Examples
                  </Button>
                </div>
              ...
              <Reveal delay={300} direction="none">
                <div className="relative aspect-square max-w-md mx-auto md:ml-auto">
                  <div className="absolute inset-0 grid grid-cols-2 grid-rows-2 gap-4">
                    {/* Feature Icons */}
                    <div className="relative glass-panel flex flex-col justify-center items-center p-6 transform transition-transform hover:scale-105">
