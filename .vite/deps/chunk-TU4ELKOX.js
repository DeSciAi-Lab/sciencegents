...
async function getWebSocketRpcClient(url, options = {}) {
  ...
  return getSocketRpcClient({
    async getSocket({ onClose, onError, onOpen, onResponse }) {
      const WebSocket = await import("./native-Q7GJUMZB.js").then((module) => module.WebSocket);
...
async function recoverPublicKey({ hash, signature }) {
  ...
  const { secp256k1: secp256k12 } = await import("./secp256k1-P2EZIDCO.js");
  const signature_ = (() => {
...
*/
//# sourceMappingURL=chunk-TU4ELKOX.js.map
